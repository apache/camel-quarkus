...
public class ActiveMQResource {
    ...
    public String consumeActiveMQMessage(@PathParam("queueName") String queueName) {
        return consumerTemplate.receiveBody("activemq:queue:" + queueName, 5000, String.class);
    }
