    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            return CollectionHelper.mapOf(
                    ...
                    "camel.component.infinispan.configuration.hosts", getHostAndPort(container, HOTROD_PORT),
                    "camel.component.infinispan.configuration.username", USER,
                    "camel.component.infinispan.configuration.password", PASS,
                    "camel.component.infinispan.configuration.secure", "true",
                    "camel.component.infinispan.configuration.security-realm", "default",
                    "camel.component.infinispan.configuration.sasl-mechanism", "DIGEST-MD5",
                    "camel.component.infinispan.configuration.security-server-name", "infinispan");
        } catch (Exception e) {
