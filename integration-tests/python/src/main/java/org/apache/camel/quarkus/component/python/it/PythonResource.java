...
public class PythonResource {
    ...
    public String hello(String message) {
        return producerTemplate.requestBody("direct:pythonHello", message, String.class);
    }
    ...
    public String hi(String message) {
        return producerTemplate.requestBody("direct:pythonMultiplyByTwoTemplate", message, String.class);
    }
