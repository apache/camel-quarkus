...
public class RocketmqResource {
    ...
    public void send(@HeaderParam("sendToEndpointUri") String sendToEndpointUri, String message) {
        ...
        producerTemplate.sendBody(sendToEndpointUri, message);
    }

    public void storeMessage(Exchange e, @Body String message) {
    ...
    public Collection<String> getRouteMessages(@PathParam("route-id") String routeId) {
        return msgStore.getOrDefault(routeId, new ConcurrentLinkedQueue<>());
    }
}
