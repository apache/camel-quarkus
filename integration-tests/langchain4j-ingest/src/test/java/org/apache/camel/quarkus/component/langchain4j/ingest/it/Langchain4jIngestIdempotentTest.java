...
class Langchain4jIngestIdempotentTest {
    ...
    /** A blank document releases its claim: only a delivery that wrote segments occupies the id. */
    @Test
    void emptyDeliveryDoesNotClaimTheId() {
        ...
        assertNotNull(Langchain4jIngestTest.hit("What does the valve regulate?", "custom", "coolant"),
                "the populated delivery must be ingested despite the earlier empty one");
    }
