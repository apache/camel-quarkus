...
public class Langchain4jEmbeddingstoreQl4jProducers {
    ...
    @Produces
    @Singleton
    ContentRetriever contentRetriever(EmbeddingModel embeddingModel, EmbeddingStoreFactory embeddingStoreFactory)
            throws Exception {
        return EmbeddingStoreContentRetriever.builder()
                .embeddingStore(embeddingStoreFactory.createEmbeddingStore())
