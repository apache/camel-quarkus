...
@Path("/dstu2_1")
@ApplicationScoped
public class FhirDstu2_1Resource {
    ...
    public String capabilities(@QueryParam("encodeAs") String encodeAs) {
        ...
        Conformance result = producerTemplate.requestBodyAndHeaders("direct:capabilities-dstu2-1", Conformance.class,
    ...
    public JsonObject createPatientAsStringResource(
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:createResourceAsString-dstu2-1", patientString,
                headers,
                MethodOutcome.class);
    ...
    public JsonObject createPatient(
        ...
        MethodOutcome result = producerTemplate.requestBody("direct:createResource-dstu2-1", patient, MethodOutcome.class);
    ...
    public Response fhir2json(
        ...
        try (InputStream response = producerTemplate.requestBody("direct:json-to-dstu2-1", patientString, InputStream.class)) {
            return Response
    ...
    public Response fhir2xml(
        ...
        try (InputStream response = producerTemplate.requestBody("direct:xml-to-dstu2-1", patientString, InputStream.class)) {
            return Response
                    .created(new URI("https:camel.apache.org/"))
                    .entity(response)
                    .build();
    ...
    public int historyOnInstance(@QueryParam("id") String id) {
        ...
        Bundle result = producerTemplate.requestBodyAndHeaders("direct:historyOnInstance-dstu2-1", null, headers, Bundle.class);
    ...
    public int historyOnServer() {
        ...
        Bundle result = producerTemplate.requestBodyAndHeaders("direct:historyOnServer-dstu2-1", null, headers, Bundle.class);
        return result.getEntry().size();
    }
    ...
    public int historyOnType() {
        ...
        Bundle result = producerTemplate.requestBodyAndHeaders("direct:historyOnType-dstu2-1", null, headers, Bundle.class);
        return result.getEntry().size();
    }
    ...
    public int loadPageByUrl() {
        ...
        Bundle result = producerTemplate.requestBodyAndHeaders("direct:loadPageByUrl-dstu2-1", null, headers, Bundle.class);
        return result.getEntry().size();
    }
    ...
    public int loadPageNext() {
        ...
        Bundle result = producerTemplate.requestBody("direct:loadPageNext-dstu2-1", bundle, Bundle.class);
        return result.getEntry().size();
    }
    ...
    public int loadPagePrevious(@QueryParam("encodeAsXml") boolean encodeAsXml) {
        ...
        Bundle result = producerTemplate.requestBodyAndHeaders("direct:loadPagePrevious-dstu2-1", bundle, headers,
                Bundle.class);
        return result.getEntry().size();
    }
    ...
    public int metaAdd(@QueryParam("id") String id) {
        ...
        IBaseMetaType result = producerTemplate.requestBodyAndHeaders("direct:metaAdd-dstu2-1", null, headers,
                IBaseMetaType.class);
    ...
    public int metaDelete(@QueryParam("id") String id) {
        ...
        IBaseMetaType result = producerTemplate.requestBodyAndHeaders("direct:metaDelete-dstu2-1", null, headers,
                IBaseMetaType.class);
        return result.getTag().size();
    }
    ...
    public int metaGetFromResource(@QueryParam("id") String id) {
        ...
        IBaseMetaType result = producerTemplate.requestBodyAndHeaders("direct:metaGetFromResource-dstu2-1", null, headers,
                IBaseMetaType.class);
        return result.getTag().size();
    }
    ...
    public int metaGetFromServer() {
        Meta result = producerTemplate.requestBody("direct:metaGetFromServer-dstu2-1", Meta.class,
                Meta.class);
        return result.getTag().size();
    }
    ...
    public int metaGetFromType(@QueryParam("preferResponseType") boolean preferResponseType) {
        ...
        IBaseMetaType result = producerTemplate.requestBodyAndHeaders("direct:metaGetFromType-dstu2-1", null, headers,
                IBaseMetaType.class);
        return result.getTag().size();
    }
    ...
    public String operationOnInstance(@QueryParam("id") String id) {
        ...
        Parameters result = producerTemplate.requestBodyAndHeaders("direct:operationOnInstance-dstu2-1", null, headers,
                Parameters.class);
    ...
    public String operationOnInstanceVersion(@QueryParam("id") String id) {
        ...
        Parameters result = producerTemplate.requestBodyAndHeaders("direct:operationOnInstanceVersion-dstu2-1", null, headers,
                Parameters.class);
    ...
    public boolean operationOnServer() {
        ...
        Parameters result = producerTemplate.requestBodyAndHeaders("direct:operationOnServer-dstu2-1", null, headers,
                Parameters.class);
        return result != null;
    }
    ...
    public String operationOnType() {
        ...
        Parameters result = producerTemplate.requestBodyAndHeaders("direct:operationOnType-dstu2-1", null, headers,
                Parameters.class);
    ...
    public String operationProcessMessage() {
        ...
        IBaseBundle result = producerTemplate.requestBodyAndHeaders("direct:operationProcessMessage-dstu2-1", null, headers,
                IBaseBundle.class);
    ...
    public String patchById(@QueryParam("id") String id, String patch) {
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:patchById-dstu2-1", null, headers,
                MethodOutcome.class);
    ...
    public String patchByStringId(
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:patchBySid-dstu2-1", null, headers,
                MethodOutcome.class);
    ...
    @PATCH
    @Produces(MediaType.TEXT_PLAIN)
    public String patchByUrl(@QueryParam("id") String id, String patch) {
        Map<String, Object> headers = new HashMap<>();
        headers.put("CamelFhir.patchBody", patch);
        headers.put("CamelFhir.url", "Patient?" + Patient.SP_RES_ID + "=" + id);
        headers.put("CamelFhir.preferReturn", null);

        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:patchByUrl-dstu2-1", null, headers,
                MethodOutcome.class);
    ...
    public Response readPatientById(@QueryParam("id") String id) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readById-dstu2-1", null, headers, Patient.class);
    ...
    public Response readPatientByLongId(@QueryParam("id") String id) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByLongId-dstu2-1", null, headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
    ...
    public Response readPatientByStringId(@QueryParam("id") String id) {
        ...
        headers.put("CamelFhir.stringId", id);
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByStringId-dstu2-1", null, headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
    ...
    public Response readPatientByIdAndStringResource(@QueryParam("id") String id) {
        ...
        headers.put("CamelFhir.id", iIdType);
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByIdAndStringResource-dstu2-1", null, headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
    ...
    public Response readPatientByLongIdAndStringResource(@QueryParam("id") String id) {
        ...
        headers.put("CamelFhir.longId", Long.valueOf(id));
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByLongIdAndStringResource-dstu2-1", null,
                    headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
    ...
    public Response readPatientByStringIdAndStringResource(@QueryParam("id") String id) {
        ...
        headers.put("CamelFhir.stringId", id);
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByStringIdAndStringResource-dstu2-1", null,
                    headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
    ...
    public Response readPatientByStringIdAndVersion(@QueryParam("id") String id, @QueryParam("version") String version) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByStringIdAndVersion-dstu2-1", null, headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
    ...
    public Response readPatientByStringIdAndVersionWithResourceClass(@QueryParam("id") String id,
        ...
        headers.put("CamelFhir.version", version);
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByStringIdAndVersionAndStringResource-dstu2-1",
                    null,
    ...
    public Response readPatientByIUrl(@QueryParam("id") String id) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByIUrl-dstu2-1", null, headers, Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
            if (cause instanceof ResourceGoneException) {
    ...
    public Response readPatientByUrl(@QueryParam("id") String id) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByUrl-dstu2-1", null, headers, Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
            if (cause instanceof ResourceGoneException) {
    ...
    public Response readPatientByStringUrlAndStringResource(@QueryParam("id") String id) {
        ...
        headers.put("CamelFhir.iUrl", new IdType(id));
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByStringUrlAndStringResource-dstu2-1", null,
                    headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
    ...
    public Response readByUrlAndStringResource(@QueryParam("id") String id, @QueryParam("prettyPrint") boolean prettyPrint) {
        ...
        try {
            Patient result = producerTemplate.requestBodyAndHeaders("direct:readByUrlAndStringResource-dstu2-1", null, headers,
                    Patient.class);
            return Response.ok().entity(patientToJsonObject(result)).build();
        } catch (CamelExecutionException e) {
            Throwable cause = e.getExchange().getException().getCause();
    ...
    public Response searchByUrl(@QueryParam("id") String id) {
        ...
        Bundle result = producerTemplate.requestBody("direct:searchByUrl-dstu2-1", url, Bundle.class);
    ...
    public String transactionWithBundle() {
        Bundle result = producerTemplate.requestBody("direct:transactionWithBundle-dstu2-1", createTransactionBundle(),
                Bundle.class);
    ...
    public String transactionWithStringBundle() {
        ...
        return producerTemplate.requestBody("direct:transactionWithStringBundle-dstu2-1", stringBundle, String.class);
    }
    ...
    public int transactionWithResources(@QueryParam("summaryEnum") boolean summaryEnum) {
        ...
        List<IBaseResource> result = producerTemplate.requestBodyAndHeaders("direct:transactionWithResources-dstu2-1", patients,
                headers, List.class);
        return result.size();
    }
    ...
    public void updateResource(@QueryParam("id") String id) throws ParseException {
        ...
        producerTemplate.sendBodyAndHeaders("direct:updateResource-dstu2-1", null, headers);
    }
    ...
    public void updateResourceWithStringId(@QueryParam("id") String id) throws ParseException {
        ...
        producerTemplate.sendBodyAndHeaders("direct:updateResourceWithStringId-dstu2-1", null, headers);
    }
    ...
    public void updateResourceAsString(@QueryParam("id") String id) throws ParseException {
        ...
        producerTemplate.sendBodyAndHeaders("direct:updateResourceAsString-dstu2-1", null, headers);
    }
    ...
    public void updateResourceAsStringWithStringId(@QueryParam("id") String id) throws ParseException {
        ...
        producerTemplate.sendBodyAndHeaders("direct:updateResourceAsStringWithStringId-dstu2-1", null, headers);
    }
    ...
    public String updateResourceBySearchUrl(@QueryParam("id") String id) throws Exception {
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:updateResourceBySearchUrl-dstu2-1", null, headers,
                MethodOutcome.class);
    ...
    public String updateResourceByUrlAndResourceAsString(@QueryParam("id") String id) throws Exception {
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders(
                "direct:updateResourceBySearchUrlAndResourceAsString-dstu2-1",
    ...
    public String validateResource() {
        ...
        MethodOutcome result = producerTemplate.requestBody("direct:validateResource-dstu2-1", patient, MethodOutcome.class);
    ...
    public String validateResourceAsString() {
        ...
        MethodOutcome result = producerTemplate.requestBody("direct:validateResourceAsString-dstu2-1", body,
                MethodOutcome.class);
    ...
    private Bundle createTransactionBundle() {
        ...
        input.addEntry()
                .setResource(new Patient()
                        .addName(new HumanName().addGiven("Art").addGiven("Tatum")))
                .getRequest()
    ...
    private IGenericClient getFhirClient() {
        FhirComponent component = context.getComponent("fhir-dstu2-1", FhirComponent.class);
