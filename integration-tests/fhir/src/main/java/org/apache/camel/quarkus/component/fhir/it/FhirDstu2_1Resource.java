...
public class FhirDstu2_1Resource {
    ...
    public JsonObject createPatientAsStringResource(
        ...
        MethodOutcome result = producerTemplate.requestBodyAndHeaders("direct:createResourceAsString-dstu2-1", patient,
                headers,
                MethodOutcome.class);
    ...
    public Response fhir2json(
        ...
        String response = producerTemplate.requestBody("direct:json-to-dstu2-1", patientString, String.class);
        return Response
    ...
    public Response fhir2xml(
        ...
        String response = producerTemplate.requestBody("direct:xml-to-dstu2-1", patientString, String.class);
        return Response
                .created(new URI("https:camel.apache.org/"))
                .entity(response)
                .build();
