...
public class LumberjackTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        return AvailablePortFinder.reserveNetworkPorts(Objects::toString, "camel.lumberjack.ssl.test-port",
                "camel.lumberjack.ssl.none.test-port", "camel.lumberjack.ssl.global.test-port");
    }
