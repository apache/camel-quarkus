...
public class CustomJasyptConfigurationCustomizer implements JasyptConfigurationCustomizer {
    @Override
    public void customize(EnvironmentStringPBEConfig environmentStringPBEConfig) {
        ...
        environmentStringPBEConfig.setIvGenerator(new RandomIvGenerator(prngAlgorithm));
        environmentStringPBEConfig.setSaltGenerator(new RandomSaltGenerator(prngAlgorithm));
    }
}
