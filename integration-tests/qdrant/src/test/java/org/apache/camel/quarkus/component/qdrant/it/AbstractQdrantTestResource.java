...
abstract class AbstractQdrantTestResource implements QuarkusTestResourceLifecycleManager {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractQdrantTestResource.class);
