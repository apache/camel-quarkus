...
public class RouteProcessorDumpRouteCoverageTest extends CamelQuarkusTestSupport {
    ...
    @Test
    public void testProcessorWithTestParameterInjection(TestInfo info, TestReporter testReporter) {
        assertNotNull(info);
    ...
    public static void checkDumpFilesCreatedAfterTests() {
        ...
        assertFileExists(
                "target/camel-route-coverage/RouteProcessorDumpRouteCoverageTest-testProcessorWithTestParameterInjection.xml");
    }
