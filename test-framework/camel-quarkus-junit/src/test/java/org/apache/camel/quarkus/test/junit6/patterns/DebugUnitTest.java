...
@TestProfile(DebugUnitTest.class)
public class DebugUnitTest extends CamelQuarkusTestSupport {

    private static final Logger LOG = Logger.getLogger(DebugUnitTest.class);
