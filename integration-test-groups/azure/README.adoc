...
To run blob versioning tests, https://learn.microsoft.com/en-us/azure/storage/blobs/versioning-enable?tabs=portal[enable blob versioning] on your storage account and set the following (requires `CAMEL_QUARKUS_START_MOCK_BACKEND=false`):
