...
public class JohnzonJsonTest {
    ...
    public void testMarshallAndUnmarshall() {
        RestAssured.given().contentType(ContentType.TEXT)
                ...
                .post("/dataformats-json-johnzon/in");
        RestAssured.given()
                .post("/dataformats-json-johnzon/out")
                .then()
    ...
    public void testUnmarshallingDifferentPojos() {
        ...
        RestAssured.given().contentType(ContentType.TEXT)
                .body(bodyA)
                .post("/dataformats-json-johnzon/in-a");
        RestAssured.given().contentType(ContentType.TEXT)
                .body(bodyB)
                .post("/dataformats-json-johnzon/in-b");
        RestAssured.given()
                .post("/dataformats-json-johnzon/out-a")
                .then()
                .body(equalTo(bodyA));
        RestAssured.given()
                .post("/dataformats-json-johnzon/out-b")
                .then()
                .body(equalTo(bodyB));
    }
    ...
    public void testUnmarshallTypeAsAttribute() {
        testUnmarshal("Johnzon-type-as-attribute");
    }

    @Test
    public void testUnmarshallTypeAsHeader() {
        testUnmarshal("Johnzon-type-as-header");
    }
    ...
    public void testUnmarshal(String directId) {
        ...
        RestAssured.given()
                ...
                .post("/dataformats-json-johnzon/unmarshal/{direct-id}", directId)
                .then()
