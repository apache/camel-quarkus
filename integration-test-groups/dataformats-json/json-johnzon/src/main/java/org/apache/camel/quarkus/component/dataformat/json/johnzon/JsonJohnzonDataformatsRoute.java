...
import org.apache.camel.quarkus.component.dataformat.json.johnzon.model.AnotherObject;
import org.apache.camel.quarkus.component.dataformat.json.johnzon.model.DummyObject;
import org.apache.camel.quarkus.component.dataformat.json.johnzon.model.PojoA;
import org.apache.camel.quarkus.component.dataformat.json.johnzon.model.PojoB;
import org.apache.camel.spi.DataFormat;
import org.apache.johnzon.mapper.reflection.JohnzonParameterizedType;

@ApplicationScoped
public class JsonJohnzonDataformatsRoute extends RouteBuilder {
    ...
    public void configureJsonRoutes(JsonLibrary library, DataFormat dummyObjectDataFormat, DataFormat pojoADataFormat,
        ...
        from("direct:Johnzon-type-as-attribute")
                .unmarshal().json(library, AnotherObject.class);

        from("direct:Johnzon-type-as-header")
                .setHeader("CamelJohnzonUnmarshalType")
                .constant("org.apache.camel.quarkus.component.dataformat.json.johnzon.model.AnotherObject")
