...
import org.apache.camel.quarkus.component.dataformat.json.jackson.model.*;
...
public class JacksonJsonResource {
    ...
    @Path("/marshal-contenttype-header")
    @GET
    ...
    @Path("/unmarshal-list-xml-configure")
    @GET
