...
import org.apache.camel.quarkus.component.dataformat.json.jackson.model.TestJAXBPojo;
import org.apache.camel.quarkus.component.dataformat.json.jackson.model.TestOtherPojo;
import org.apache.camel.quarkus.component.dataformat.json.jackson.model.TestPojo;
import org.apache.camel.quarkus.component.dataformat.json.jackson.model.TestPojoView;
...
public class JacksonXmlResource {
    ...
    @Path("xml/unmarshal-type-header")
    @POST
    ...
    @Path("xml/marshal-includedefault")
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @Path("xml/marshal-contenttype-header")
    @GET
    ...
    @Path("xml/marshal-spring-enablefeature")
    @GET
    ...
    @Path("xml/unmarshal-listjackson")
    @GET
    ...
    @Path("xml/typeheader-not-allowed")
    @GET
