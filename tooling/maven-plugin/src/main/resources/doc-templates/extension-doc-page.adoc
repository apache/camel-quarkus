...
[.badges]
[.badge-key]##JVM since##[.badge-supported]##[=jvmSince]## [.badge-key]##Native[=nativeSupported?then(' since', '')]##[.badge-[=nativeSupported?then('', 'un')]supported]##[=nativeSupported?then(nativeSince, 'unsupported')]##[#if status == 'Experimental' ] [.badge-key]##🧪##[.badge-unsupported]##Experimental##[/#if][#if deprecated ] [.badge-key]##⚠️##[.badge-unsupported]##Deprecated##[/#if]
endif::[]
...
[/#if]
[#if quarkusLangChain4jSupport?? ]
[=quarkusLangChain4jSupport]
[/#if]
[/#if]
