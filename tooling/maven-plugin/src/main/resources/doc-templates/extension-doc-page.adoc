...
* [#if camelBitLink(model, models)?contains("xref")][=camelBitLink(model, models)][[=model.title][#if model.kind != "other" ] [=humanReadableKind(model.kind)][/#if]][#if model.kind == "component" ], URI syntax: `[=model.syntax]`[/#if][#else][=camelBitLink(model, models)][/#if]
[/#list]
