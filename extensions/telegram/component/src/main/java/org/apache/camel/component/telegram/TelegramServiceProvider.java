...
/**
 * Provides access to an instance of the Telegram service. It allows changing the default implementation of the service
 * for testing purposes.
 * Currently the Telegram API does not allow a Bot sending messages to other BOTs
 * (https://core.telegram.org/bots/faq#why-doesn-39t-my-bot-see-messages-from-other-bots),
 * so the service needs to be mocked for end-to-end testing.
 *
 * The Rest client used as default implementation is thread safe, considering the current usage of the APIs. It is
...
public final class TelegramServiceProvider {
     ...
     */
    public static TelegramServiceProvider get_() {
        synchronized (LOCK) {
            if (instance == null) {
