...
public interface RestBotAPI {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult sendPhoto(@PathParam("authorizationToken") String authorizationToken, MultipartFormDataOutput attachments);

    @POST
    @Path("/bot{authorizationToken}/sendAudio")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult sendAudio(@PathParam("authorizationToken") String authorizationToken, MultipartFormDataOutput attachments);

    @POST
    @Path("/bot{authorizationToken}/sendVideo")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult sendVideo(@PathParam("authorizationToken") String authorizationToken, MultipartFormDataOutput attachments);

    @POST
    @Path("/bot{authorizationToken}/sendDocument")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult sendDocument(@PathParam("authorizationToken") String authorizationToken, MultipartFormDataOutput attachments);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult editMessageLiveLocation(@PathParam("authorizationToken") String authorizationToken,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    MessageResult stopMessageLiveLocation(@PathParam("authorizationToken") String authorizationToken,
