...
// components: START
Number of Camel components: 73 in 63 JAR artifacts (0 deprecated)
...
| xref:extensions/file-watch.adoc[camel-quarkus-file-watch]  | 1.0.0-M5 | Watch file modification events in a folder
