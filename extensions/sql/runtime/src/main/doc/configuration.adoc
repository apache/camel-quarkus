...
SQL aggregation repositories like `JdbcAggregationRepository` require native serialization support, which this extension enables for you. Refer to the xref:user-guide/native-mode.adoc#serialization[native mode user guide] for more information.
