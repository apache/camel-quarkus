...
public class GroovyRecorder {
    public void setGroovyClassLoader(RuntimeValue<CamelContext> camelContextRuntimeValue) {
        CamelContext camelContext = camelContextRuntimeValue.getValue();
        GroovyScriptClassLoader classLoader = new GroovyScriptClassLoader(camelContext.getApplicationContextClassLoader());
