...
/**
 * Transforms usage of javax.xml.bind in software.amazon.kinesis.retrieval.AggregatorUtil. TODO: Remove this:
 * https://github.com/apache/camel-quarkus/issues/6238
 */
public class JakartaEnablement {
    @BuildStep
    void transformToJakarta(BuildProducer<BytecodeTransformerBuildItem> transformers) {
        if (QuarkusClassLoader.isClassPresentAtRuntime("jakarta.xml.bind.DatatypeConverter")) {
            ...
            final BytecodeTransformerBuildItem item = new BytecodeTransformerBuildItem.Builder()
                    ...
                    .setClassToTransform("software.amazon.kinesis.retrieval.AggregatorUtil")
