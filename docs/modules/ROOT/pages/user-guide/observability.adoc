...
We provide two choices for exposing metrics. The xref:reference/extensions/micrometer.adoc[Micrometer] extension (preferred) which integrates with https://quarkus.io/guides/micrometer[Quarkus Micrometer].
