...
For a simplified observability experience, use the xref:reference/extensions/observability-services.adoc[Observability Services] extension. It provides all the above-mentioned features, together with some opinionated configuration defaults.
