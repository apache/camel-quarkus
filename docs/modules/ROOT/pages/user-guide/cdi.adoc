...
INFO: We aim at supporting all use cases listed in xref:manual::bean-binding.adoc[Bean binding] section of Camel documentation.
...
- see the xref:manual:ROOT:pojo-consuming.adoc[Pojo consuming] section of Camel documentation.
