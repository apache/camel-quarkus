...
Build scans from GitHub Actions CI builds are uploaded to the Apache Develocity instance.
Published scans can be found at https://develocity.apache.org/scans/?search.rootProjectNames=camel%20quarkus[Camel Quarkus build scans].
