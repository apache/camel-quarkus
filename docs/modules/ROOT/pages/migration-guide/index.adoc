...
* xref:migration-guide/4.0.0.adoc[Camel Quarkus 3.40.x to Camel Quarkus 4.0.0 migration guide]
...
* xref:migration-guide/3.35.0.adoc[Camel Quarkus 3.33.x to Camel Quarkus 3.35.0 migration guide]
* xref:migration-guide/3.33.0.adoc[Camel Quarkus 3.32.x to Camel Quarkus 3.33.0 migration guide]
* xref:migration-guide/3.31.0.adoc[Camel Quarkus 3.30.x to Camel Quarkus 3.31.0 migration guide]
...
* xref:migration-guide/camel-spring-boot-to-camel-quarkus.adoc[Camel Spring Boot to Camel Quarkus migration]
