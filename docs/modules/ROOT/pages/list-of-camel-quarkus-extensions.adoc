...
// components: START
Number of Camel components: 42 in 37 JAR artifacts (0 deprecated)
...
| link:https://camel.apache.org/components/latest/git-component.html[Git] (camel-quarkus-git) +
`git:localPath` | 0.5 | The git component is used for working with git repositories.
