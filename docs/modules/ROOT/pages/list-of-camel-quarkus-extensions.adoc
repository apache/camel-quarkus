...
| link:https://camel.apache.org/components/latest/tidyMarkup-dataformat.html[TidyMarkup] (camel-quarkus-tagsoup) | 0.3 | TidyMarkup data format is used for parsing HTML and return it as pretty well-formed HTML.
