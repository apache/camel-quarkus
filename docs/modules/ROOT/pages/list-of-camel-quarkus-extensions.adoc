...
| link:https://camel.apache.org/components/latest/freemarker-component.html[Freemarker] (camel-quarkus-freemarker) +
`freemarker:resourceUri` | 0.1 | Transforms the message using a FreeMarker template.
