...
// components: START
Number of Camel components: 157 in 122 JAR artifacts (2 deprecated)
...
| xref:extensions/arangodb.adoc[ArangoDb] | camel-quarkus-arangodb | Native + Stable | 1.1.0 | Perform operations on ArangoDb documents, collections and graphs.
