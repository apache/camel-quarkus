...
/**
 * In case that non-default BC provider has to be registered, use this buildItem.
 * (provider available for registration is `BCPQC`)
 */
public final class BouncyCastleAdditionalProviderBuildItem extends MultiBuildItem {
