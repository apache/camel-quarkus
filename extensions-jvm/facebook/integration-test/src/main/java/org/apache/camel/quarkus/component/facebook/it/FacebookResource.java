...
public class FacebookResource {
    ...
    public Response loadComponentFacebook() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", COMPONENT_FACEBOOK);
        return Response.status(500, COMPONENT_FACEBOOK + " could not be loaded from the Camel context").build();
    }
}
