...
public class XchangeResource {
    ...
    public Response loadComponentXchange() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", COMPONENT_XCHANGE);
        return Response.status(500, COMPONENT_XCHANGE + " could not be loaded from the Camel context").build();
    }
}
