...
public class DoclingResource {
    ...
    public Response loadComponentDocling() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", COMPONENT_DOCLING);
        return Response.status(500, COMPONENT_DOCLING + " could not be loaded from the Camel context").build();
    }
}
