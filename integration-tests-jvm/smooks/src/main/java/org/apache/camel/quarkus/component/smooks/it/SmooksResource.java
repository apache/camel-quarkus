...
public class SmooksResource {
    ...
    public Response loadComponentSmooks() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", COMPONENT_SMOOKS);
        return Response.status(500, COMPONENT_SMOOKS + " could not be loaded from the Camel context").build();
    }
    ...
    public Response loadDataformatSmooks() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", DATAFORMAT_SMOOKS);
        return Response.status(500, DATAFORMAT_SMOOKS + " could not be loaded from the Camel context").build();
    }
}
