...
class CxfClientTest {
    ...
    public void loadComponentCxf() {
        ...
        RestAssured.get("/cxf/load/component/cxf")
                .then()
                .statusCode(200);
    }
    ...
    public void testSimpleSoapClient() {
        final String response = RestAssured.get("/cxf/sendSimpleSoapRequest")
                .then()
                .statusCode(201)
                .assertThat()
                .extract().asString();
    ...
    public void testWSSecurity() {
        final String response = RestAssured.get("/cxf/wsSecurity")
                .then()
                .statusCode(201)
                .assertThat()
                .extract().asString();
    ...
    public void testComplexSoapClient() {
        final String response = RestAssured.get("/cxf/sendComplexSoapRequest")
                .then()
                .statusCode(201)
                .assertThat()
                .extract().asString();
