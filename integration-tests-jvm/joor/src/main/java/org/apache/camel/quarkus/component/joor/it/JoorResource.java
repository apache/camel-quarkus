...
public class JoorResource {
    ...
    private static final Logger LOG = Logger.getLogger(JoorResource.class);
    ...
    public Response loadLanguageJoor() throws Exception {
        /* This is an autogenerated test */
        if (context.resolveLanguage(LANGUAGE_JOOR) != null) {
