...
public class OpensearchResource {
    ...
    public Response loadComponentOpensearch() throws Exception {
        ...
        LOG.warnf("Could not load [%s] from the Camel context", COMPONENT_OPENSEARCH);
        return Response.status(500, COMPONENT_OPENSEARCH + " could not be loaded from the Camel context").build();
    }
}
